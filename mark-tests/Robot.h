...
#define CHAN_LIFT_ENCODER_LEFT_A 9 //dio
#define CHAN_LIFT_ENCODER_LEFT_B 8 //dio
...
#define PID_POS_TOL 100 //multiply by the encoder distance per pulse to get the distance around the setpoint that is considered to be at the setpoint (setpoint tolerance)

#define ENC_DIST_PER_PULSE 1.0
