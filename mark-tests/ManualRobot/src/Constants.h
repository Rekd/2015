...
#define MAX_RPS								8
#define DRIVE_DB_LOW 						-0.2 //drive deadband low limit
#define DRIVE_DB_HIGH 						0.2 //drive deadband high limit
...
#define AUTONMOUS_MOVE_DIST					-5.73 //tire revolutions; for 4 in wheels ~6 feet; - for backwards, + for forwards

//current monitoring
#define FORK_CURRENT_LIMIT					7.0
...
#define FORK_MOTOR_SPEED_OUT				0.5 //unsigned, set sign when used
#define FORK_MOTOR_SPEED_IN					0.5 //unsigned, set sign when used
