...
class DriveSystem {
    ...
    DriveSystem(Encoder *left, Encoder *right, SpeedController *ml, SpeedController *mr) {
        ...
        double distPerPulse  = 1.0 / DRIVE_ENCODER_RESOLUTION;
        ...
        controlLeft = new PIDController(DRIVE_PROPORTIONAL_TERM, DRIVE_INTEGRAL_TERM, DRIVE_DIFFERENTIAL_TERM,
        		m_pLeftEncoder, m_pscMotorLeft);
        controlRight = new PIDController(DRIVE_PROPORTIONAL_TERM, DRIVE_INTEGRAL_TERM, DRIVE_DIFFERENTIAL_TERM,
